...
```
$ curl -s "http://localhost:31325/analyses/5b46cfc7-c363-4aaa-9260-b3b6bfe7177b/parameters?proxyToken=$(cas-ticket)" | python -mjson.tool
{
    ...
    "parameters": [
        {
            ...
            "param_value": {
                "value": "/iplant/home/dennis/foo.csv"
            }
        },
        {
            "data_format": "",
