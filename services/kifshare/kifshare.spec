...
install target/kifshare-3.1.1-standalone.jar $RPM_BUILD_ROOT/usr/local/lib/kifshare/
...
%attr(0644,iplant,iplant) /usr/local/lib/kifshare/kifshare-3.1.1-standalone.jar
