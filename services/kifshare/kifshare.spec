...
install target/kifshare-4.0.3-standalone.jar $RPM_BUILD_ROOT/usr/local/lib/kifshare/
...
%attr(0644,iplant,iplant) /usr/local/lib/kifshare/kifshare-4.0.3-standalone.jar
