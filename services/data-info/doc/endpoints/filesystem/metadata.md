...
including all IRODS AVUs visible to the client and Metadata Template AVUs to the file specified in
the request body by the "dest" path. If the "recursive" field is present and is not 'false', and if
...
__Error codes__: ERR_INVALID_JSON, ERR_EXISTS, ERR_DOES_NOT_EXIST, ERR_NOT_READABLE,
...
```json
{
    "dest": "/iplant/home/ipctest/metadata.json",
    "recursive": true
}
```
...
```json
{
    "success": true,
    "file": {
        "id": "ab8950f2-d409-11e4-8920-6abdce5a08d5",
        "path": "/iplant/home/ipctest/metadata.json",
        "share-count": 0,
        "date-created": 1427409872000,
        "md5": "88783b2dad5b875cf60fb9896a513617",
        "permission": "own",
        "date-modified": 1427409872000,
        "type": "file",
        "file-size": 428,
