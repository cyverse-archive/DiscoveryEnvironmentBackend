...
ALTER TABLE ONLY app_category_app RENAME COLUMN template_group_id TO template_group_id_v187;
ALTER TABLE ONLY app_category_app RENAME COLUMN template_id TO template_id_v187;
