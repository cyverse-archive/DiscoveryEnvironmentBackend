...
ALTER TABLE ONLY app_steps RENAME COLUMN transformation_task_id TO transformation_task_id_v187;
ALTER TABLE ONLY app_steps RENAME COLUMN transformation_step_id TO transformation_step_id_v187;
