...
ALTER TABLE ONLY rule_type_value_type ALTER COLUMN rule_type_id_v187 DROP NOT NULL;
ALTER TABLE ONLY rule_type_value_type ALTER COLUMN value_type_id_v187 DROP NOT NULL;
