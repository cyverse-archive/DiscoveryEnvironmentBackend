...
ALTER TABLE ONLY workspace RENAME COLUMN home_folder TO home_folder_v187;
ALTER TABLE ONLY workspace RENAME COLUMN root_analysis_group_id TO root_analysis_group_id_v187;
