...
ALTER TABLE ONLY tools RENAME COLUMN hid TO hid_v187;
ALTER TABLE ONLY tools RENAME COLUMN id TO id_v187;
ALTER TABLE ONLY tools ALTER COLUMN id_v187 DROP NOT NULL;
ALTER TABLE ONLY tools RENAME COLUMN tool_type_id TO tool_type_id_v187;
ALTER TABLE ONLY tools ALTER COLUMN tool_type_id_v187 DROP NOT NULL;
ALTER TABLE ONLY tools RENAME COLUMN integration_data_id TO integration_data_id_v187;
ALTER TABLE ONLY tools ALTER COLUMN integration_data_id_v187 DROP NOT NULL;
