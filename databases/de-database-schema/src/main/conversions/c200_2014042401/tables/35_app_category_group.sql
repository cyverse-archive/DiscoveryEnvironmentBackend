...
ALTER TABLE ONLY app_category_group RENAME COLUMN parent_group_id TO parent_group_id_v187;
ALTER TABLE ONLY app_category_group RENAME COLUMN subgroup_id TO subgroup_id_v187;
ALTER TABLE ONLY app_category_group ALTER COLUMN subgroup_id_v187 DROP NOT NULL;
