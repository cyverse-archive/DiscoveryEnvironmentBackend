...
ALTER TABLE ONLY apps ALTER COLUMN workspace_id_v187 DROP NOT NULL;
...
ALTER TABLE ONLY apps ALTER COLUMN integration_data_id_v187 DROP NOT NULL;
ALTER TABLE ONLY apps RENAME COLUMN wikiurl TO wiki_url;
ALTER TABLE ONLY apps ADD COLUMN id_v187 CHARACTER VARYING(255);
UPDATE apps SET id_v187 = id;
