...
ALTER TABLE ONLY tool_request_statuses ALTER COLUMN tool_request_id_v187 DROP NOT NULL;
ALTER TABLE ONLY tool_request_statuses ALTER COLUMN updater_id_v187 DROP NOT NULL;
