...
(defn- add-app-categories-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY app_categories ALTER COLUMN id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY app_categories RENAME COLUMN workspace_id TO workspace_id_v187")
  (exec-sql-statement "ALTER TABLE ONLY app_categories ADD COLUMN workspace_id TYPE UUID"))
...
(defn- alter-workspace-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY workspace ADD COLUMN id TYPE UUID USING (uuid_generate_v4())")
  (exec-sql-statement "ALTER TABLE ONLY workspace ADD COLUMN root_category_id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY workspace RENAME COLUMN user_id TO user_id_v187")
  (exec-sql-statement "ALTER TABLE ONLY workspace ADD COLUMN user_id TYPE UUID"))
...
(defn- add-tools-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY tools ALTER COLUMN id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY tools RENAME COLUMN tool_type_id TO tool_type_id_v187")
  (exec-sql-statement "ALTER TABLE ONLY tools ADD COLUMN tool_type_id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY tools RENAME COLUMN integration_data_id TO integration_data_id_v187")
  (exec-sql-statement "ALTER TABLE ONLY tools ADD COLUMN integration_data_id TYPE UUID"))
...
(defn- add-tasks-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY tasks ALTER COLUMN id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY tasks RENAME COLUMN component_id TO component_id_v187")
  (exec-sql-statement "ALTER TABLE ONLY tasks ADD COLUMN component_id TYPE UUID"))
...
(defn- add-apps-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY apps ALTER COLUMN id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY apps RENAME COLUMN workspace_id TO workspace_id_v187")
  (exec-sql-statement "ALTER TABLE ONLY apps ADD COLUMN workspace_id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY apps RENAME COLUMN integration_data_id TO integration_data_id_v187")
  (exec-sql-statement "ALTER TABLE ONLY apps ADD COLUMN integration_data_id TYPE UUID"))
...
(defn- add-app-steps-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY app_steps ADD COLUMN id TYPE UUID USING (uuid_generate_v4())")
  (exec-sql-statement "ALTER TABLE ONLY app_steps RENAME COLUMN hid TO step")
  (exec-sql-statement "ALTER TABLE ONLY app_steps ADD COLUMN app_id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY app_steps ADD COLUMN task_id TYPE UUID"))
...
(defn- alter-integration-data-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY integration_data ADD COLUMN id TYPE UUID USING (uuid_generate_v4())"))
...
(defn- alter-ratings-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY ratings ADD COLUMN id TYPE UUID USING (uuid_generate_v4())")
  (exec-sql-statement "ALTER TABLE ONLY ratings RENAME COLUMN user_id TO user_id_v187")
  (exec-sql-statement "ALTER TABLE ONLY ratings ADD COLUMN user_id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY ratings ADD COLUMN app_id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY ratings RENAME COLUMN comment_id TO comment_id_v187")
  (exec-sql-statement "ALTER TABLE ONLY ratings ADD COLUMN comment_id TYPE UUID"))
...
(defn- add-app-category-app-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY app_category_app ADD COLUMN app_category_id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY app_category_app ADD COLUMN app_id TYPE UUID"))
...
(defn- alter-data-formats-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY data_formats ALTER COLUMN id TYPE UUID"))
...
(defn- add-workflow-io-maps-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY workflow_io_maps ADD COLUMN app_id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY workflow_io_maps ADD COLUMN target_step TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY workflow_io_maps ADD COLUMN source_step TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY workflow_io_maps ALTER COLUMN input TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY workflow_io_maps ALTER COLUMN output TYPE UUID"))
...
(defn- add-file-parameters-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY file_parameters ALTER COLUMN id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY file_parameters RENAME COLUMN info_type TO info_type_v187")
  (exec-sql-statement "ALTER TABLE ONLY file_parameters ADD COLUMN info_type TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY file_parameters RENAME COLUMN data_format TO data_format_v187")
  (exec-sql-statement "ALTER TABLE ONLY file_parameters ADD COLUMN data_format TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY file_parameters RENAME COLUMN multiplicity TO multiplicity_v187")
  (exec-sql-statement "ALTER TABLE ONLY file_parameters ADD COLUMN multiplicity TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY file_parameters RENAME COLUMN data_source_id TO data_source_id_v187")
  (exec-sql-statement "ALTER TABLE ONLY file_parameters ADD COLUMN data_source_id  TYPE UUID"))
...
(defn- add-tool-test-data-files-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY tool_test_data_files ADD COLUMN id TYPE UUID USING (uuid_generate_v4())")
  (exec-sql-statement "ALTER TABLE ONLY tool_test_data_files ADD COLUMN tool_id TYPE UUID"))
...
(defn- alter-info-type-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY info_type ALTER COLUMN id TYPE UUID"))
...
(defn- alter-multiplicity-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY multiplicity ALTER COLUMN id TYPE UUID"))
...
(defn- add-parameters-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY parameters ALTER COLUMN id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY parameters ADD COLUMN parameter_group_id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY parameters ADD COLUMN parameter_type TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY parameters ADD COLUMN required TYPE boolean DEFAULT false")
  (exec-sql-statement "ALTER TABLE ONLY parameters ADD COLUMN file_parameter_id TYPE UUID"))
...
(defn- add-parameter-groups-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY parameter_groups ALTER COLUMN id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY parameter_groups ADD COLUMN task_id TYPE UUID"))
...
(defn- add-parameter-types-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY parameter_types ALTER COLUMN id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY parameter_types RENAME COLUMN value_type_id TO value_type_id_v187")
  (exec-sql-statement "ALTER TABLE ONLY parameter_types ADD COLUMN value_type_id TYPE UUID"))
...
(defn- alter-users-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY users ADD COLUMN id TYPE UUID USING (uuid_generate_v4())"))
...
(defn- add-validation-rules-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY validation_rules ALTER COLUMN id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY validation_rules ADD COLUMN parameter_id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY validation_rules RENAME COLUMN rule_type TO rule_type_v187")
  (exec-sql-statement "ALTER TABLE ONLY validation_rules ADD COLUMN rule_type TYPE UUID"))
...
(defn- add-validation-rule-arguments-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY validation_rule_arguments ADD COLUMN id TYPE UUID USING (uuid_generate_v4())")
  (exec-sql-statement "ALTER TABLE ONLY validation_rule_arguments RENAME COLUMN rule_id TO rule_id_v187")
  (exec-sql-statement "ALTER TABLE ONLY validation_rule_arguments ADD COLUMN rule_id TYPE UUID"))
...
(defn- alter-rule-subtype-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY rule_subtype ALTER COLUMN id TYPE UUID"))
...
(defn- alter-rule-type-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY rule_type ALTER COLUMN id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY rule_type RENAME COLUMN rule_subtype_id TO rule_subtype_id_v187")
  (exec-sql-statement "ALTER TABLE ONLY rule_type ADD COLUMN rule_subtype_id TYPE UUID"))
...
(defn- alter-rule-type-value-type-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY rule_type_value_type ADD COLUMN rule_type_id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY rule_type_value_type RENAME COLUMN value_type_id TO value_type_id_v187")
  (exec-sql-statement "ALTER TABLE ONLY rule_type_value_type ADD COLUMN value_type_id TYPE UUID"))
...
(defn- alter-suggested_groups-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY suggested_groups ADD COLUMN app_id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY suggested_groups ADD COLUMN app_category_id TYPE UUID"))
...
(defn- add-app-category-group-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY app_category_group ADD COLUMN parent_category_id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY app_category_group ADD COLUMN child_category_id TYPE UUID"))
...
(defn- add-app-references-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY app_references ADD COLUMN id TYPE UUID USING (uuid_generate_v4())")
  (exec-sql-statement "ALTER TABLE ONLY app_references ADD COLUMN app_id TYPE UUID"))
...
(defn- alter-value-type-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY value_type ALTER COLUMN id TYPE UUID"))
...
(defn- alter-genome-ref-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY genome_ref ALTER COLUMN id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY genome_ref RENAME COLUMN created_by TO created_by_v187")
  (exec-sql-statement "ALTER TABLE ONLY genome_ref ADD COLUMN created_by TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY genome_ref RENAME COLUMN last_modified_by TO last_modified_by_v187")
  (exec-sql-statement "ALTER TABLE ONLY genome_ref ADD COLUMN last_modified_by TYPE UUID"))
...
(defn- alter-collaborators-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY collaborators ADD COLUMN user_id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY collaborators RENAME COLUMN collaborator_id TO collaborator_id_v187")
  (exec-sql-statement "ALTER TABLE ONLY collaborators ADD COLUMN collaborator_id TYPE UUID"))
...
(defn- alter-data-source-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY data_source ALTER COLUMN id TYPE UUID"))
...
(defn- alter-tool-types-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY tool_types ADD COLUMN id TYPE UUID USING (uuid_generate_v4())"))
...
(defn- add-tool-type-parameter-type-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY tool_type_parameter_type ADD COLUMN tool_type_id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY tool_type_parameter_type ADD COLUMN parameter_type_id TYPE UUID"))
...
(defn- alter-tool-architectures-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY tool_architectures ADD COLUMN id TYPE UUID USING (uuid_generate_v4())"))
...
(defn- alter-tool-requests-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY tool_requests ADD COLUMN requestor_id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY tool_requests RENAME COLUMN tool_architecture_id TO tool_architecture_id_v187")
  (exec-sql-statement "ALTER TABLE ONLY tool_requests ADD COLUMN tool_architecture_id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY tool_requests ADD COLUMN tool_id TYPE UUID"))
...
(defn- alter-tool-request-statuses-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY tool_request_statuses ADD COLUMN id TYPE UUID USING (uuid_generate_v4())")
  (exec-sql-statement "ALTER TABLE ONLY tool_request_statuses RENAME COLUMN tool_request_id TO tool_request_id_v187")
  (exec-sql-statement "ALTER TABLE ONLY tool_request_statuses ADD COLUMN tool_request_id TYPE UUID")
  (exec-sql-statement "ALTER TABLE ONLY tool_request_statuses RENAME COLUMN updater_id TO updater_id_v187")
  (exec-sql-statement "ALTER TABLE ONLY tool_request_statuses ADD COLUMN updater_id TYPE UUID"))
...
(defn- alter-logins-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY logins ADD COLUMN user_id TYPE UUID"))
...
(defn- alter-job_types-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY job_types ADD COLUMN id TYPE UUID USING (uuid_generate_v4())"))
...
(defn- alter-jobs-table
  ...
  (exec-sql-statement "ALTER TABLE ONLY jobs ADD COLUMN job_type_id TYPE UUID")
