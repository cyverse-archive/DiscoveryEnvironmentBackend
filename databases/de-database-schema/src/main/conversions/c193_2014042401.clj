...
(defn- drop-all-constraints
  ...
  (exec-sql-statement "
    ...
    BEGIN
      ...
      END LOOP;
    END$$;")
  (load-sql-file "conversions/c193_2014042401/drop_constraints.sql"))

(defn- drop-views
  []
  (println "\t* dropping old views...")
  (load-sql-file "conversions/c193_2014042401/drop_views.sql"))
...
(defn- run-table-conversions
  ...
  (load-sql-file "conversions/c193_2014042401/tables/rename_obsolete_tables.sql")
  (println "\t* updating the template_group table to app_categories")
  (load-sql-file "conversions/c193_2014042401/tables/01_app_categories.sql")
  (println "\t* updating the workspace table")
  (load-sql-file "conversions/c193_2014042401/tables/02_workspace.sql")
  (println "\t* updating the deployed_components table to tools")
  (load-sql-file "conversions/c193_2014042401/tables/03_tools.sql")
  (println "\t* updating the template table to tasks")
  (load-sql-file "conversions/c193_2014042401/tables/04_tasks.sql")
  (println "\t* adding agave step tasks")
  (add-agave-step-tasks)
  (println "\t* updating the transformation_activity table to apps")
  (load-sql-file "conversions/c193_2014042401/tables/05_apps.sql")
  (println "\t* updating the transformation_task_steps table to app_steps")
  (load-sql-file "conversions/c193_2014042401/tables/07_app_steps.sql")
  (println "\t* updating the integration_data table")
  (load-sql-file "conversions/c193_2014042401/tables/09_integration_data.sql")
  (println "\t* updating the ratings table")
  (load-sql-file "conversions/c193_2014042401/tables/10_ratings.sql")
  (println "\t* updating the template_group_template table to app_category_app")
  (load-sql-file "conversions/c193_2014042401/tables/11_app_category_app.sql")
  (println "\t* updating the data_formats table")
  (load-sql-file "conversions/c193_2014042401/tables/12_data_formats.sql")
  (println "\t* updating the input_output_mapping table to workflow_io_maps")
  (load-sql-file "conversions/c193_2014042401/tables/13_workflow_io_maps.sql")
  (println "\t* updating the dataobject_mapping table to input_output_mapping")
  (load-sql-file "conversions/c193_2014042401/tables/18_input_output_mapping.sql")
  (println "\t* updating the dataobjects table to file_parameters")
  (load-sql-file "conversions/c193_2014042401/tables/14_file_parameters.sql")
  (println "\t* updating the deployed_component_data_files table to tool_test_data_files")
  (load-sql-file "conversions/c193_2014042401/tables/15_tool_test_data_files.sql")
  (println "\t* updating the info_type table")
  (load-sql-file "conversions/c193_2014042401/tables/17_info_type.sql")
  (println "\t* updating the property table to parameters")
  (load-sql-file "conversions/c193_2014042401/tables/24_parameters.sql")
  (println "\t* updating the property_group table to parameter_groups")
  (load-sql-file "conversions/c193_2014042401/tables/25_parameter_groups.sql")
  ...
  (load-sql-file "conversions/c193_2014042401/tables/27_parameter_types.sql")
  (println "\t* updating the users table")
  (load-sql-file "conversions/c193_2014042401/tables/28_users.sql")
  (println "\t* updating the rule table to validation_rules")
  (load-sql-file "conversions/c193_2014042401/tables/29_validation_rules.sql")
  (println "\t* updating the rule_argument table to validation_rule_arguments")
  (load-sql-file "conversions/c193_2014042401/tables/30_validation_rule_arguments.sql")
  (println "\t* updating the rule_subtype table")
  (load-sql-file "conversions/c193_2014042401/tables/31_rule_subtype.sql")
  (println "\t* updating the rule_type table")
  (load-sql-file "conversions/c193_2014042401/tables/32_rule_type.sql")
  (println "\t* updating the rule_type_value_type table")
  (load-sql-file "conversions/c193_2014042401/tables/33_rule_type_value_type.sql")
  (println "\t* updating the suggested_groups table")
  (load-sql-file "conversions/c193_2014042401/tables/34_suggested_groups.sql")
  (println "\t* updating the template_group_group table to app_category_group")
  (load-sql-file "conversions/c193_2014042401/tables/35_app_category_group.sql")
  (println "\t* updating the transformation_activity_references table to app_references")
  (load-sql-file "conversions/c193_2014042401/tables/40_app_references.sql")
  (println "\t* updating the value_type table")
  (load-sql-file "conversions/c193_2014042401/tables/44_value_type.sql")
  (println "\t* updating the version table")
  (load-sql-file "conversions/c193_2014042401/tables/45_version.sql")
  (println "\t* updating the genome_reference table")
  (load-sql-file "conversions/c193_2014042401/tables/46_genome_reference.sql")
  (println "\t* updating the collaborators table")
  (load-sql-file "conversions/c193_2014042401/tables/47_collaborators.sql")
  (println "\t* updating the data_source table")
  (load-sql-file "conversions/c193_2014042401/tables/48_data_source.sql")
  (println "\t* updating the tool_types table")
  (load-sql-file "conversions/c193_2014042401/tables/49_tool_types.sql")
  (println "\t* updating the tool_type_property_type table to tool_type_parameter_type")
  (load-sql-file "conversions/c193_2014042401/tables/50_tool_type_parameter_type.sql")
  (println "\t* updating the tool_request_status_codes table")
  (load-sql-file "conversions/c193_2014042401/tables/51_tool_request_status_codes.sql")
  (println "\t* updating the tool_architectures table")
  (load-sql-file "conversions/c193_2014042401/tables/52_tool_architectures.sql")
  (println "\t* updating the tool_requests table")
  (load-sql-file "conversions/c193_2014042401/tables/53_tool_requests.sql")
  (println "\t* updating the tool_request_statuses table")
  (load-sql-file "conversions/c193_2014042401/tables/54_tool_request_statuses.sql")
  (println "\t* updating the logins table")
  (load-sql-file "conversions/c193_2014042401/tables/55_logins.sql")
  (println "\t* updating the job_types table")
  (load-sql-file "conversions/c193_2014042401/tables/56_job_types.sql")
  (println "\t* updating the jobs table")
  (load-sql-file "conversions/c193_2014042401/tables/57_jobs.sql")
  (println "\t* updating the metadata_value_types table")
  (load-sql-file "conversions/c193_2014042401/tables/58_metadata_value_types.sql")
  (println "\t* updating the metadata_templates table")
  (load-sql-file "conversions/c193_2014042401/tables/59_metadata_templates.sql")
  (println "\t* updating the metadata_attributes table")
  (load-sql-file "conversions/c193_2014042401/tables/60_metadata_attributes.sql")
  (println "\t* updating the user_preferences table")
  (load-sql-file "conversions/c193_2014042401/tables/63_user_preferences.sql")
  (println "\t* updating the user_sessions table")
  (load-sql-file "conversions/c193_2014042401/tables/64_user_sessions.sql")
  (println "\t* updating the tree_urls table")
  (load-sql-file "conversions/c193_2014042401/tables/65_tree_urls.sql")
  (println "\t* updating the user_saved_searches table")
  (load-sql-file "conversions/c193_2014042401/tables/66_user_saved_searches.sql")
  (println "\t* updating the access_tokens table")
  (load-sql-file "conversions/c193_2014042401/tables/67_access_tokens.sql")
  (println "\t* updating the authorization_requests table")
  (load-sql-file "conversions/c193_2014042401/tables/68_authorization_requests.sql")
  (println "\t* updating the job_steps table")
  (load-sql-file "conversions/c193_2014042401/tables/69_job_steps.sql"))
...
(defn- run-uuid-conversions
  ...
  (load-sql-file "conversions/c193_2014042401/uuids/01_app_categories.sql")
  (println "\t* updating workspace uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/02_workspace.sql")
  (println "\t* updating tools uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/03_tools.sql")
  (println "\t* updating tasks uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/04_tasks.sql")
  (println "\t* updating apps uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/05_apps.sql")
  (println "\t* updating app_steps uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/07_app_steps.sql")
  (println "\t* updating integration_data uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/09_integration_data.sql")
  (println "\t* updating data_formats uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/12_data_formats.sql")
  (println "\t* updating workflow_io_maps uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/13_workflow_io_maps.sql")
  (println "\t* updating info_type uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/17_info_type.sql")
  (println "\t* updating parameters uuid foreign keys (this might take a minute or 2)...")
  (load-sql-file "conversions/c193_2014042401/uuids/24_parameters.sql")
  (println "\t* updating parameter_groups uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/25_parameter_groups.sql")
  (println "\t* updating parameter_types uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/27_parameter_types.sql")
  (println "\t* updating users uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/28_users.sql")
  (println "\t* updating validation_rules uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/29_validation_rules.sql")
  (println "\t* updating rule_subtype uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/31_rule_subtype.sql")
  (println "\t* updating rule_type uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/32_rule_type.sql")
  (println "\t* updating value_type uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/44_value_type.sql")
  (println "\t* updating data_source uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/48_data_source.sql")
  (println "\t* updating tool_types uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/49_tool_types.sql")
  (println "\t* updating tool_architectures uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/52_tool_architectures.sql")
  (println "\t* updating tool_requests uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/53_tool_requests.sql")
  (println "\t* updating job_types uuid foreign keys...")
  (load-sql-file "conversions/c193_2014042401/uuids/56_job_types.sql")
  (println "\t* updating jobs uuid foreign keys")
  (load-sql-file "conversions/c193_2014042401/uuids/57_jobs.sql"))

(defn- drop-obsolete-tables
  []
  (println "\t* dropping empty obsolete tables")
  (load-sql-file "conversions/c193_2014042401/tables/drop_empty_obsolete_tables.sql"))
...
(defn- add-new-data
  ...
  (load-sql-file "conversions/c193_2014042401/data/01_parameter_types.sql")
  (println "\t* adding new tool types...")
  (load-sql-file "conversions/c193_2014042401/data/02_tool_types.sql")
